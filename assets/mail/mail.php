...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $number = filter_var(trim($_POST["phone"]), FILTER_SANITIZE_EMAIL);
...
<div class="container">
    ...
    <p class="saludo">Estimados amigos de creativa,</p>
    <p>' . $message . '</p>
...
?>
        ...
        <title>Creativa Publicidad & Tecnologia</title>
                ...
                <div class="container">
                    <div class="row">
                        <div style="text-align: center;">
                            <figure class="figure">
                                <img src="../images/LOGO CREATIVA PNG.png" style="width: 490px; height: 281px;" class="figure-img img-fluid rounded" alt="...">
                            </figure>
                        </div>
                    </div>
                    <div class="row">
