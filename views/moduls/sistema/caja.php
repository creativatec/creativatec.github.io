...
<div class="container mt-2">
    ...
    <form action="" method="post">
        ...
        <div style="text-align: right;">
            ...
            ?>
            <button id="imprimirFactura" class="btn btn-primary preFactura" data-toggle="modal" data-target="#modalImpresion">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalImpresionLabel">Elige el formato de impresión</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <button id="btnImprimirPDF" class="btn btn-primary">Imprimir en PDF</button>
                    <button id="Imprimir" class="btn btn-secondary">Imprimir en POS</button>
                </div>
            </div>
        </div>
    </div>
