...
if (isset($_GET['action'])) {
    if ($_GET['action'] == "agregarMedida") {
        print '<script>
        swal("Hurra!!!", "Medida agregada exitosamente", "success");
    </script>';
    }
    if ($_GET['action'] == "actualizarMedida") {
        print '<script>
        swal("Hurra!!!", "Medida actualizar exitosamente", "success");
    </script>';
    }
}
///Usuario
$user = new ControladorMedida();
$user->agregarMedida();
$res = $user->listarMedida();
//activo
            ...
            <tbody>
                ...
                foreach ($res as $key => $value) {
                    ...
                    <tr>
                        ...
                        <td><a href="index.php?action=medida&id=<?php echo $value['id_medida'] ?>"><i
...
<!-- Modal Editar Medida-->
<div class="modal fade" id="medida" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Medida</label>
                            <input type="text" class="form-control" value="<?php echo $listar[0]['nombre_medida'] ?>"
                                name="med" id="inputEmail4" placeholder="Medida">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="">Activo</label>
                            <select id="" name="activo" class="form-control">
